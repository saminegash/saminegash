# Hi ![](https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif), I'm Samuel Negash
...
I specialize in building scalable web and mobile applications using **Next.js**, **Node.js**, and **Flutter**. Currently, I am deeply focused on **Generative AI**, designing intelligent architectures for **RAG (Retrieval-Augmented Generation)** systems and **Voice/Document Agents**.

I combine robust full-stack engineering with modern AI solutions to create interactive, agentic workflows that solve real-world problems.

Core competencies:

- 💻 **Full-Stack:** Next.js, Node.js, Flutter
- 🧠 **Generative AI:** RAG, AI Agents, Voice Integration
- 🛠️ **System Architecture:** Scalable Backend & Vector Search

---

- 🌍 Based in Addis Ababa, Ethiopia
- 🖥️ Portfolio: [saminegash.team-sami.uk](https://saminegash.team-sami.uk)
- ✉️ Contact: [smlnegash@gmail.com](mailto:smlnegash@gmail.com)
- 🚀 **Current Focus:** Building autonomous Voice & Document Agents
- 👯 Open to collaborating on GenAI and Agentic workflow projects
...
- **App Development:** Building cross-platform mobile apps with Flutter and high-performance web apps with Next.js.
- **AI Agents:** Developing autonomous agents capable of voice interaction and complex document analysis.
- **RAG Systems:** Implementing vector search and LLM orchestration for context-aware applications.
...
<p align="left">
  ...
  <a href="https://weaviate.io/" target="_blank" rel="noreferrer">
    <img src="https://weaviate.io/img/site/weaviate-logo-dark.png" width="36" height="36" alt="Weaviate (Vector DB)" />
  </a>
